...
=======
    ...
    if dataset_name not in valid_datasets:
        raise ValueError(f"Invalid dataset: {dataset_name}. Must be one of {valid_datasets}")
    ...
    project_root = Path(__file__).parent.parent.parent.parent  # Go up from src/exploration_hacking/settings/science/ to project root
    data_path = project_root / data_dir / dataset_name / f"{dataset_name}_{split}.parquet"
