...
>>>>>>> Stashed changes
    ...
    def extract_answer(self, model_output: str) -> Tuple[Optional[str], Optional[str], Optional[str]]:
        """
...
>>>>>>> Stashed changes
        ...
        return {
            ...
            and (model_output.find("</think>") < model_output.find("<justification>")
                 if "</think>" in model_output and "<justification>" in model_output else False),
...
=======
            and (model_output.find("</justification>") < model_output.find("<answer>")
                 if "</justification>" in model_output and "<answer>" in model_output else False),
            "answer": answer,
